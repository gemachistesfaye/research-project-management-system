...
class ForgotPasswordTest extends TestCase
{
    ...
    {
        $user = User::factory()->create([
            'email'    => 'gooduser@institution.org',
    ...
    {
        $user = User::factory()->create([
            'email'    => 'profileuser@institution.org',
    ...
    {
        $user = User::factory()->create([
            'email'    => 'profileuser2@institution.org',
            'password' => Hash::make('Current@123'),
        ]);
