...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
    <div>
        ...
        <a href="{{ Storage::url($project->proposal_document_url) }}" target="_blank" class="btn btn-sm btn-outline-dark ms-2 mt-2 mt-md-0 d-inline-block" title="View Proposal Document">
    ...
    <div class="w-100 w-md-auto d-flex justify-content-start justify-content-md-end">
        <a href="{{ route('progress.index') }}" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-left me-1"></i> Back to Progress List
        </a>
    </div>
</div>
