            ...
            <div class="p-3 border rounded-3 bg-light h-100 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <ul class="list-unstyled small text-muted mb-3 ps-1">
                        ...
                        <li><i class="bi bi-database text-dark me-1"></i> Directory: <strong>Research Project Management System Central HR</strong></li>
                    </ul>
                </div>
        ...
        <div class="col-md-6">
            <div class="p-3 border rounded-3 bg-light h-100 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <p class="small text-muted mb-2">
                        Enterprise interface syncing approved research purchase orders, lab chemicals, and System property tags.
                    </p>
                    <ul class="list-unstyled small text-muted mb-3 ps-1">
