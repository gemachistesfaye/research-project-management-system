...
@section('content')
<h3 class="fw-bold mb-4"><i class="bi bi-building me-2 text-dark"></i>Department Management</h3>
<div class="d-flex justify-content-between align-items-center mb-3">
    <span class="text-muted small">Manage academic departments and their college assignments</span>
    <button type="button" class="btn btn-dark fw-bold" data-bs-toggle="modal" data-bs-target="#createDeptModal">
