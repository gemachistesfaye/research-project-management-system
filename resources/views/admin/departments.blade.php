...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2 mb-4">
    <div>
        <h3 class="fw-bold mb-0"><i class="bi bi-building me-2 text-dark"></i>Department Management</h3>
        <span class="text-muted small">Manage academic departments and their college assignments</span>
    </div>
    <div>
        <button type="button" class="btn btn-dark fw-bold text-nowrap" data-bs-toggle="modal" data-bs-target="#createDeptModal">
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.departments.store') }}">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark fw-bold confirm-btn" data-confirm-title="Create Department" data-confirm-message="Create this new department?" data-confirm-icon="bi-building" data-confirm-color="text-dark" data-confirm-btn-text="Yes, Create" data-confirm-btn-class="btn-dark">Create Department</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.departments.update', $d->id) }}">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-dark fw-bold confirm-btn" data-confirm-title="Update Department" data-confirm-message="Save changes to this department?" data-confirm-icon="bi-check-circle" data-confirm-color="text-dark" data-confirm-btn-text="Yes, Save" data-confirm-btn-class="btn-dark">Update Department</button>
                </div>
            </form>
        </div>
    </div>
