...
<head>
    ...
    <title>404 - Page Not Found | GMU-RPMS</title>
                ...
                <div class="error-card p-5 text-center">
                    ...
                    <div class="mt-3 p-3 bg-light rounded-3 text-start">
                        ...
                        <div class="row g-2">
                            ...
                            @endauth
                            <div class="col-6">
                                <a href="mailto:admin@gmu.edu.et" class="text-decoration-none small"><i class="bi bi-envelope me-1"></i> Contact Support</a>
                            </div>
                        </div>
                    </div>
                </div>
