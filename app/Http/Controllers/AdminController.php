...
class AdminController extends Controller
{
    ...
    public function triggerHrmsPing(Request $request)
    {
        ...
        return back()->with('success', 'UNI HRMS Staff Payroll API ping successful. Verified connection to Research Project Management System Enterprise Directory (Latency: 28ms).');
    }
